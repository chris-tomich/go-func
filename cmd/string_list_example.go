...
import (
	"fmt"
	e "github.com/chris-tomich/go-func/string_list_example"
	"time"
	"math/rand"
)

func StandardLoopExampleWithConcurrency(bagOfWords e.StringList) {
...
func StandardLoopExampleWithoutConcurrency(bagOfWords e.StringList) {
	sentence1, sentence2 := "", ""
...
func TypedExampleWithConcurrency(bagOfWords e.StringList) {
...
func TypedExampleWithoutConcurrency(bagOfWords e.StringList) {
	query1 := bagOfWords.Map(func (word string) string { return word + " " })
